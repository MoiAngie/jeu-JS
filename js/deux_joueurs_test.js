...
/* Je crée une autre fonction en cas d'égalité disant que si les cases ne sont pas vides, et que les cases sont différentes
entre elles, elle doit lancer la fonction pour alerter de l'égalité*/

function drawState() {
if (cases[].innerHTML !== '' && cases[0].innerHTML !== cases[1].innerHTML || cases[1].innerHTML !== cases[2].innerHTML) {
   affichDraw(cases[0].innerHTML);
}
else if (cases[].innerHTML !== '' && cases[3].innerHTML !== cases[4].innerHTML || cases[4].innerHTML !== cases[5].innerHTML) {
    affichDraw(cases[3].innerHTML);
}
else if (cases[].innerHTML !== '' && cases[6].innerHTML !== cases[7].innerHTML || cases[7].innerHTML !== cases[8].innerHTML) {
    affichDraw(cases[6].innerHTML);
}
// Pour les verticales
else if (cases[].innerHTML !== '' && cases[0].innerHTML !== cases[3].innerHTML || cases[3].innerHTML !== cases[6].innerHTML) {
    affichDraw(cases[0].innerHTML);
}
else if (cases[].innerHTML !== '' && cases[1].innerHTML !== cases[4].innerHTML || cases[4].innerHTML !== cases[7].innerHTML) {
    affichDraw(cases[1].innerHTML);
}
else if (cases[].innerHTML !== '' && cases[2].innerHTML !== cases[5].innerHTML || cases[5].innerHTML !== cases[8].innerHTML) {
    affichDraw(cases[2].innerHTML);
}
// Pour les diagonales
else if (cases[].innerHTML !== '' && cases[0].innerHTML !== cases[4].innerHTML || cases[4].innerHTML !== cases[8].innerHTML) {
    affichDraw(cases[0].innerHTML);
}
else if (cases[].innerHTML !== '' && cases[2].innerHTML !== cases[4].innerHTML || cases[4].innerHTML !== cases[6].innerHTML) {
    affichDraw(cases[2].innerHTML);
}
}*/
